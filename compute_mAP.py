...
def parse_opt():
    ...
    parser.add_argument("-bathPath", type=str, default='Final_Database/' , help="bath_path")
    parser.add_argument("-queryFile", type=str, default='queryImages.txt' , help="queryFile")
    parser.add_argument("-classesFile", type=str, default='dataClasses.txt' , help="classesFile")
...
if __name__ == "__main__":
    ...
    for i in range(0, querysNum):
        ...
        #dists = np.linalg.norm(feats.T-queryFeat, axis=1)
        #print(dists)
        # finding sum of squares
       
        print(queryClassNum,end = "\t")  # numb of images present in particular class
        print(scores)
        rank_ID = np.argsort(scores)[::-1]  # gives Indices of the score vect in decending order
        rank_score = scores[rank_ID]        # scores in desc order 1...0
